...
<head>
    ...
    <!-- Document Title
	============================================= -->
    <title>GP Consultoria e Assessoria Contábil</title>
...
<body>
    ...
    <div id="carouselExampleFade" class="carousel slide carousel-fade" data-bs-ride="carousel">
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="consultoria_1024_300.jpg" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
                <img src="servicos_1024_300.jpg" class="d-block w-100" alt="...">
            </div>
    ...
    <section id="content">
        ...
        <div class="container">
            ...
            <div class="row justify-content-center mb-5" id="servicos">
                <div class="col-lg-7 text-center">
                    <div class="heading-block">
                        <h3 class="text-transform-none mb-3 fw-semibold ls-0">Como podemos deixas sua vida mais simples
                        </h3>
                        <span class="text-black-50">GP Consultoria e Assessoria Contábil é uma empresa com amplos
                            conhecimentos em Gestão Previdenciária.</span>
                    </div>
                </div>
                ...
                <div class="col-lg-8">
                    <div class="row align-items-center">
                        <div class="col-sm-6">
                            <img src="contabeis.jpg" alt="Image 1">
                        </div>
                        <div class="col-sm-6">
                    ...
                    <div class="row align-items-center mt-5">
                        <div class="col-sm-6 mb-4 mb-sm-0">
                            <h3>Assessoria e Consultoria Previdenciária</h3>
                            <p class="mb-2">
                                Assessoria e Consultoria Previdenciária são serviços que visam auxiliar na compreensão e
                        ...
                        <div class="col-sm-6">
                            <img src="20944578.jpg" alt="Image 1">
                        </div>
                    </div>
                    ...
                    <div class="row align-items-center mt-5">
                        <div class="col-sm-6">
                            <img src="20944690.jpg" alt="Image 1">
                        </div>
                        <div class="col-sm-6">
                            <h3>Estruturação Previdenciária</h3>
                            <p class="mb-2">A Estruturação Previdenciária é um serviço que tem como objetivo ajudar
                                empresas
                                e organizações a elaborar planos de previdência privada para seus funcionários. Isso
                                inclui
                                a definição de regras, contribuições e benefícios, bem como a gestão dos recursos do
                                plano.
                    ...
                    <div class="row align-items-center mt-5">
                        <div class="col-sm-6 mb-4 mb-sm-0">
                            <h3>Assessoria e Treinamentos
                            </h3>
                            <p class="mb-2">

                                Os serviços de Assessoria e Treinamentos na área contábil são projetados para ajudar
                                empresas e indivíduos a melhorar seus conhecimentos contábeis e financeiros. Isso inclui
                                orientação em questões contábeis, tributárias e regulatórias, bem como treinamentos em
                        ...
                        <div class="col-sm-6">
                            <img src="treinamento.jpg" alt="Image 1">
                        </div>
                    </div>
